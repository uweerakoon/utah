...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Search table" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "_START_-_END_ / _TOTAL_ Entries",
	...
	$.extend( DataTable.ext.classes, {
		...
		"sFilter": "dataTables_filter input-group pull-right",
		"sInfo": "dataTables_info label label-minimum",
