...
function OverlayI()
{
    ...
    var layers = [
        ...
        pm10XML,
        pm25XML,
        airshedXML,         //Update OverlayTwo.prototype.toggle if position canges.
        airshedlabelsXML    //Always at the end?  Update OverlayTwo.prototype.toggle if position changes.
        //firewxXML,
        //firepotentialXML
    ];
    ...
    this.legacy = function()
    {
         ...
         *  If returns true, OverlayTwo should default to basic features.
         */
...
OverlayI.prototype.setMap = function(map)
{
    /**
...
OverlayI.prototype.toggle = function(layerId, map)
{
    /**
...
OverlayI.prototype.toggleWms = function(imageId, map)
{
    /**
...
OverlayI.prototype.toggleDetects = function(SDate, EDate, map)
{
    /**
    ...
    if (this.hmsActive == false) {
        ...
        this.hmsActive = false;
        $('#hms-detect-toggle').css('backgroundColor', OverlayTwo.inactiveColor());
    }
}

OverlayI.prototype.setControls = function(map)
{
    /**
...
OverlayI.prototype.toggleControl = function(controlDiv, map, control) 
{
    /**
    ...
    controlUI.style.backgroundColor = OverlayTwo.inactiveColor();
    ...
    google.maps.event.addDomListener(controlUI, 'click', function() {
        result = OverlayTwo.toggle(control.layerId, map);
...
OverlayI.prototype.hmsControl = function(controlDiv, map)
{
    /**
...
OverlayI.prototype.wmsControl = function(controlDiv, map, control) 
{
    /**
    ...
    google.maps.event.addDomListener(controlUI, 'click', function() {
        result = OverlayTwo.toggleWms(control.imageId, map);
...
OverlayI.prototype.hmsForm = function()
{
    /**
     * HMS date selector form.
     */

    var title = "Show HMS Detect OverlayTwo";
    
    var append = "";

    if (this.hmsActive) {
        append = "<button class=\"btn btn-default btn-block\" onclick=\"OverlayTwo.hideHms()\">Hide HMS Detects</button>";
    }
    ...
    var html = " \
            ...
            <button class=\"btn btn-default btn-block\" onclick=\"OverlayTwo.addHms(map)\">Show HMS Detects</button> \
            "+ append +" \
...
OverlayI.prototype.addHms = function(map)
{
    /**
     *  Process HMS form.
     */
...
OverlayI.prototype.hideHms = function()
{
    /**
